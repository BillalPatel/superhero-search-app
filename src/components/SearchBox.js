...
const SearchBox = ({searchfield, searchChange}) => {
	return (
  		<div className='bg-light-green mw7 center pa3 br2-ns ba b--black-10'>
		    <div className='cf'>
				<input type='search' placeholder='Type search' onChange={searchChange} className='f6 f5-l input-reset bn fl black-80 bg-white pa3 lh-solid w-100 w-75-m w-80-l br2-ns br--left-ns'/>
